...
#connectd_task_notify 1 $1 "Job at stage x"

# Clear all status columns A-E in remot3.it portal

ret=$(${TOOL_DIR}/connectd_task_notify a $1 $2 "")
ret=$(${TOOL_DIR}/connectd_task_notify b $1 $2 "")
ret=$(${TOOL_DIR}/connectd_task_notify c $1 $2 "")
ret=$(${TOOL_DIR}/connectd_task_notify d $1 $2 "")
ret=$(${TOOL_DIR}/connectd_task_notify e $1 $2 "")
# ret=$(${TOOL_DIR}/connectd_task_notify a $1 $2 "")
# ret=$(${TOOL_DIR}/connectd_task_notify b $1 $2 "")
# ret=$(${TOOL_DIR}/connectd_task_notify c $1 $2 "")
# ret=$(${TOOL_DIR}/connectd_task_notify d $1 $2 "")
...
ret=$(${TOOL_DIR}/connectd_task_notify a $1 $2 "$krelease")
# ret=$(${TOOL_DIR}/connectd_task_notify a $1 $2 $os)
#-------------------------------------------------
# Update status column B (StatusB) in remot3.it portal
#-------------------------------------------------
# retrieve the Linux kernel version
connectd_version=$(${TOOL_DIR}/connectd.arm-linaro-pi |awk NR==2'{print "connectd " $2}')
# send to status column b in remot3.it portal
ret=$(${TOOL_DIR}/connectd_task_notify b $1 $2 "$connectd_version")
# ret=$(${TOOL_DIR}/connectd_task_notify b $1 $2 "$krelease")
#-------------------------------------------------
...
ret=$(${TOOL_DIR}/connectd_task_notify c $1 $2 "$uptime")
# ret=$(${TOOL_DIR}/connectd_task_notify c $1 $2 "$uptime")
#-------------------------------------------------
...
# send to status d
# ret=$(${TOOL_DIR}/connectd_task_notify d $1 $2 "$sys")
# ret=$(${TOOL_DIR}/connectd_task_notify d $1 $2 "$sys")
temp=$(vcgencmd measure_temp)
ret=$(${TOOL_DIR}/connectd_task_notify d $1 $2 "$temp")
#-------------------------------------------------
...
date=$(date)
# send to status e
# ret=$(${TOOL_DIR}/connectd_task_notify e $1 $2 "$memfree")
ret=$(${TOOL_DIR}/connectd_task_notify e $1 $2 "$date")
# ret=$(${TOOL_DIR}/connectd_task_notify e $1 $2 "$memfree")
#-------------------------------------------------

#=======================================================================
# ${TOOL_DIR}/connectd_task_notify 1 $1 $2 "Job at stage 3"
#=======================================================================
# Lastly finalize job, no updates allowed after this
ret=$(${TOOL_DIR}/connectd_task_notify 1 $1 $2 "Job complete")
# ret=$(${TOOL_DIR}/connectd_task_notify 1 $1 $2 "Job complete")

# Use this for error, and message
#${TOOL_DIR}/connectd_task_notify 2 $1 $2 "Job Failed"
